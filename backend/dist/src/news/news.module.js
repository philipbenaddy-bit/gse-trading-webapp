...
exports.NewsModule = NewsModule = __decorate([
    (0, common_1.Module)({
        ...
        providers: [news_service_1.NewsService, news_aggregator_service_1.NewsAggregatorService],
        exports: [news_service_1.NewsService, news_aggregator_service_1.NewsAggregatorService],
    })
], NewsModule);
