 ...
 *
 * Constrains the LLM to GSE-related topics only and prevents
 * disclosure of system instructions, API keys, or internal architecture.
 *
 * Requirements: 4.4, 4.6
 */

export interface SystemPromptParams {
  /** Current date in ISO format for temporal grounding */
  currentDate: string;
}

/**
 * Generates the system prompt that constrains the LLM to GSE topics,
 * prevents information leakage, and enforces response guidelines.
 */
